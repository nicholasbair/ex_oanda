defmodule ExOanda.GuaranteedStopLossOrderRequest do
  @moduledoc """
  Schema for Oanda guaranteed stop loss order request.

  [Oanda Docs](https://developer.oanda.com/rest-live-v20/order-df/#GuaranteedStopLossOrderRequest)
  """
  ...
  typed_embedded_schema do
    field(:type, Ecto.Enum, values: [:GUARANTEED_STOP_LOSS], default: :GUARANTEED_STOP_LOSS)
