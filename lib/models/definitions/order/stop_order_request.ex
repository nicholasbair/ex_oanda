defmodule ExOanda.StopOrderRequest do
  @moduledoc """
  Schema for Oanda stop order request.

  [Oanda Docs](https://developer.oanda.com/rest-live-v20/order-df/#StopOrderRequest)
  """
  ...
  typed_embedded_schema do
    field(:type, Ecto.Enum, values: [:STOP], default: :STOP)
