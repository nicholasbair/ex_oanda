defmodule ExOanda.TrailingStopLossOrderRejectTransaction do
  @moduledoc """
  Schema for Oanda trailing stop loss order reject transaction.
  ...
  typed_embedded_schema do
    ...
    field(:type, Atom, default: :TRAILING_STOP_LOSS_ORDER_REJECT)
