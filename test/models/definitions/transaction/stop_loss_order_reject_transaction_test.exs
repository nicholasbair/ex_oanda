defmodule ExOanda.StopLossOrderRejectTransactionTest do
  use ExUnit.Case, async: true
  alias ExOanda.StopLossOrderRejectTransaction

  describe "changeset/2" do
    test "changeset with empty params" do
      params = %{}

      changeset = StopLossOrderRejectTransaction.changeset(%StopLossOrderRejectTransaction{}, params)
