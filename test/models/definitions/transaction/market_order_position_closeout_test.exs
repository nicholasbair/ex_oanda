defmodule ExOanda.MarketOrderPositionCloseoutTest do
  use ExUnit.Case, async: true
  alias ExOanda.MarketOrderPositionCloseout

  describe "changeset/2" do
    test "changeset with empty params" do
      params = %{}

      changeset = MarketOrderPositionCloseout.changeset(%MarketOrderPositionCloseout{}, params)
