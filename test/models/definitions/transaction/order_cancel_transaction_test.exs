defmodule ExOanda.OrderCancelTransactionTest do
  use ExUnit.Case, async: true
  alias ExOanda.OrderCancelTransaction

  describe "changeset/2" do
    test "changeset with empty params" do
      params = %{}

      changeset = OrderCancelTransaction.changeset(%OrderCancelTransaction{}, params)
