defmodule ExOanda.MarketIfTouchedOrderRejectTransactionTest do
  ...
  describe "changeset/2" do
    test "changeset with empty params" do
      ...
      changeset = ExOanda.MarketIfTouchedOrderRejectTransaction.changeset(%ExOanda.MarketIfTouchedOrderRejectTransaction{}, params)
