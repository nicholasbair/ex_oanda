defmodule ExOanda.TradeClientExtensionsModifyRejectTransactionTest do
  ...
  describe "changeset/2" do
    test "changeset with empty params" do
      ...
      changeset = ExOanda.TradeClientExtensionsModifyRejectTransaction.changeset(%ExOanda.TradeClientExtensionsModifyRejectTransaction{}, params)
