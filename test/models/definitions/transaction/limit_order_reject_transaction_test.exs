defmodule ExOanda.LimitOrderRejectTransactionTest do
  use ExUnit.Case, async: true
  alias ExOanda.LimitOrderRejectTransaction

  describe "changeset/2" do
    test "changeset with empty params" do
      params = %{}

      changeset = LimitOrderRejectTransaction.changeset(%LimitOrderRejectTransaction{}, params)
