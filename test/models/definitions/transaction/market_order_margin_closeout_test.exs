defmodule ExOanda.MarketOrderMarginCloseoutTest do
  use ExUnit.Case, async: true
  alias ExOanda.MarketOrderMarginCloseout

  describe "changeset/2" do
    test "changeset with empty params" do
      params = %{}

      changeset = MarketOrderMarginCloseout.changeset(%MarketOrderMarginCloseout{}, params)
