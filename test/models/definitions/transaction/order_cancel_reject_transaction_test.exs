defmodule ExOanda.OrderCancelRejectTransactionTest do
  use ExUnit.Case, async: true
  alias ExOanda.OrderCancelRejectTransaction

  describe "changeset/2" do
    test "changeset with empty params" do
      params = %{}

      changeset = OrderCancelRejectTransaction.changeset(%OrderCancelRejectTransaction{}, params)
