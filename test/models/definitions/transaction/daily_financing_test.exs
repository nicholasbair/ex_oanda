defmodule ExOanda.DailyFinancingTransactionTest do
  use ExUnit.Case, async: true
  alias ExOanda.DailyFinancingTransaction

  describe "changeset/2" do
    test "changeset with empty params" do
      params = %{}

      changeset = DailyFinancingTransaction.changeset(%DailyFinancingTransaction{}, params)
