defmodule ExOanda.LimitOrderTransactionTest do
  use ExUnit.Case, async: true
  alias ExOanda.LimitOrderTransaction

  describe "changeset/2" do
    test "changeset with empty params" do
      params = %{}

      changeset = LimitOrderTransaction.changeset(%LimitOrderTransaction{}, params)
