defmodule ExOanda.ResetResettablePLTransactionTest do
  use ExUnit.Case, async: true
  alias ExOanda.ResetResettablePLTransaction

  describe "changeset/2" do
    test "changeset with empty params" do
      params = %{}

      changeset = ResetResettablePLTransaction.changeset(%ResetResettablePLTransaction{}, params)
