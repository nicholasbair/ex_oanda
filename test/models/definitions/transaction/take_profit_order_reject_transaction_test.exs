defmodule ExOanda.TakeProfitOrderRejectTransactionTest do
  use ExUnit.Case, async: true
  alias ExOanda.TakeProfitOrderRejectTransaction

  describe "changeset/2" do
    test "changeset with empty params" do
      params = %{}

      changeset = TakeProfitOrderRejectTransaction.changeset(%TakeProfitOrderRejectTransaction{}, params)
