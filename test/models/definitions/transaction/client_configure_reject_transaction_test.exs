defmodule ExOanda.ClientConfigureRejectTransactionTest do
  ...
  describe "changeset/2" do
    test "changeset with empty params" do
      ...
      changeset = ExOanda.ClientConfigureRejectTransaction.changeset(%ExOanda.ClientConfigureRejectTransaction{}, params)
