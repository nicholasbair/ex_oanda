defmodule ExOanda.CalculatedPositionStateTest do
  use ExUnit.Case, async: true

  alias ExOanda.CalculatedPositionState

  describe "changeset/2" do
    test "changeset with empty params" do
      params = %{}

      changeset = CalculatedPositionState.changeset(%CalculatedPositionState{}, params)
