defmodule ExOanda.Response.ListPendingOrdersTest do
  use ExUnit.Case, async: true

  alias ExOanda.Response.ListPendingOrders

  describe "changeset/2" do
    test "changeset with empty params" do
      params = %{}

      changeset = ListPendingOrders.changeset(%ListPendingOrders{}, params)
